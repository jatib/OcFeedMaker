...
**/
	...
	$feedHead = "id\t";
	$feedHead .= "title\t";
	$feedHead .= "description\t";
	$feedHead .= "google product category\t";
	$feedHead .= "product type\t";
	$feedHead .= "link\t";
	$feedHead .= "image link\t";
	$feedHead .= "condition\t";
	$feedHead .= "availability\t";
	$feedHead .= "price\t";
	$feedHead .= "sale price\t";
	$feedHead .= "sale price effective date\t";
	$feedHead .= "gtin\t";
	$feedHead .= "brand\t";
	$feedHead .= "mpn\t";
	$feedHead .= "item group id\t";
	$feedHead .= "gender\t";
	$feedHead .= "age group\t";
	$feedHead .= "color\t";
	$feedHead .= "size\t";
	$feedHead .= "shipping\t";
	$feedHead .= "shipping weight\n";
